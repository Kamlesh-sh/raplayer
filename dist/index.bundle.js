			...
			function VideoControls(props) {
				...
				_this.render = function (_ref, _ref2) {
					...
					return (0, _preact.h)("div", {
						...
						selectedTrack: selectedTrack
					})), controlOptions.subtitles && (0, _preact.h)("div", { className: _index2.default.controlButton }, (0, _preact.h)("div", null, (0, _preact.h)("button", {
						style: "border:none",
						type: "button",
						className: _index2.default.subtitles,
						onClick: _this.toggleSubtitles
					})), (0, _preact.h)("div", { className: [subtitlesOn ? _index2.default.subtitlesUnderline : null].join(" ") })), controlOptions.download && downloadSrc && (0, _preact.h)("div", { className: _index2.default.controlButton }, (0, _preact.h)("a", {
						target: "_blank",
						style: "border:none",
						type: "button",
						href: downloadSrc,
