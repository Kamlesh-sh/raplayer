		...
		var CommentBox = function (_Component) {
			...
			_createClass(CommentBox, [{
				...
				value: function shouldComponentUpdate(nextProps, nextState) {
					...
					if (xPos !== nextProps.xPos || time !== nextProps.time || commentText !== nextProps.commentText || readOnly !== nextProps.readOnly || downArrowXPos !== nextProps.downArrowXPos || edit !== nextProps.edit || showError !== nextProps.showError || author !== nextProps.author || fullScreen !== nextProps.fullScreen || isSubmitting !== nextState.isSubmitting) {
						return true;
					}
