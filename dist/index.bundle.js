...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(28), __webpack_require__(27), __webpack_require__(26), __webpack_require__(14), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(exports, require("@utils/apiUtils"), require("@config/api.config"), require("@models/comment"), require("@models/transcriptionModel"), require("@api/api"), require("@config/trackEvents"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod.exports, global.apiUtils, global.api, global.comment, global.transcriptionModel, global.api, global.trackEvents);
	...
	(function (global, factory) {
	...
	})(undefined, function (exports, _apiUtils, _api, _comment, _transcriptionModel, _api3, _trackEvents) {
		"use strict";
		...
		var _transcriptionModel2 = _interopRequireDefault(_transcriptionModel);
		...
		var actions = exports.actions = function actions() {
			return {
				...
				getTranscriptionData: function getTranscriptionData(state, payload, setState) {
					...
					return (0, _apiUtils.post)(_api2.default.getTranscriptionData(state.app), { body: requestObj }).then(function (response) {
						var transcriptArray = [].concat(_toConsumableArray(response.timestampedTranscripts));
				...
				navigateToMatchNum: function navigateToMatchNum(state, _ref6) {
					...
					var _transcriptionModel$h = _transcriptionModel2.default.highlightCurrentMatch(state.transcriptionPane.searchedTranscripts, currentMatchNumber, state.transcriptionPane.searchBar.currentMatchNumber, state.transcriptionPane.matchedTranscriptIndices),
					    highlightedTranscripts = _transcriptionModel$h.highlightedTranscripts;
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  (function (global, factory) {
    ...
    var STRING_TRANSCRIPTION_FAILED = exports.STRING_TRANSCRIPTION_FAILED = "<div style='font-weight: 600;'>Oops! </div>Sorry, Smart Transcribe couldn't transcribe this submission. Please proceed with reviewing.";
    ...
    var CLASS_SEARCH_HIGHLIGHT = exports.CLASS_SEARCH_HIGHLIGHT = "searchHighlightStyle";
    var CLASS_CURRENT_MATCH_HIGHLIGHT = exports.CLASS_CURRENT_MATCH_HIGHLIGHT = "currentMatchHighlightStyle";
  });
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(36), __webpack_require__(35), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		...
		factory(module, exports, require("@config/constants"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.constants);
		global.transcriptionModel = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	(function (global, factory) {
	...
	})(undefined, function (module, exports, _constants) {
		"use strict";
		...
		var transcriptionModel = {
			search: function search(timestampedTranscripts, searchPhrases) {
				...
				var searchedTranscripts = timestampedTranscripts.map(function (timestampedTranscript, index) {
					...
					searchPhrases.forEach(function (phrase) {
						...
						var i = 0;
						var pos = text.toLowerCase().indexOf(phraseWithSpaces, i);
						while (pos != -1) {
							var actualPos = pos + 1;
			...
			highlightText: function highlightText(text) {
				...
				return "<span class='" + _constants.CLASS_SEARCH_HIGHLIGHT + "'>" + text + "</span>";
			},
			...
			sort: function sort(timestampedTranscripts) {
				var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "time";

				return timestampedTranscripts.sort(function (a, b) {
					if (a[key] === b[key]) {
			...
			highlightCurrentMatch: function highlightCurrentMatch(searchedTranscripts, currentMatchNumber, prevMatchNumber, matchedTranscriptIndices) {
				...
				var i = currentMatchNumber - 2;
				var indexInTranscript = 1;
				while (i >= 0 && matchedTranscriptIndices[i] == curIndex) {
					indexInTranscript++;
					i--;
				}
				var curTranscript = transcripts[curIndex].text;

				i = 1;
				var pos = curTranscript.indexOf(_constants.CLASS_SEARCH_HIGHLIGHT, 0);
				while (pos != -1) {
					if (i == indexInTranscript) {
						curTranscript = curTranscript.substr(0, pos) + _constants.CLASS_CURRENT_MATCH_HIGHLIGHT + curTranscript.substr(pos + _constants.CLASS_SEARCH_HIGHLIGHT.length);
						break;
					} else {
						i++;
						pos = curTranscript.indexOf(_constants.CLASS_SEARCH_HIGHLIGHT, pos + _constants.CLASS_SEARCH_HIGHLIGHT.length);
					}
				}
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(45), __webpack_require__(33), __webpack_require__(3), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("./index.scss"), require("../CommentCard"), require("@utils/core"), require("@config/constants"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.index, global.CommentCard, global.core, global.constants);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	})(undefined, function (module, exports, _preact, _index, _CommentCard, _core, _constants) {
		"use strict";
					...
					if (!comments || !comments.length) {
						...
						return (0, _preact.h)("div", { className: _index2.default.commentPane }, comments.map(function (comment, i) {
							return (0, _preact.h)(_CommentCard2.default, {
								...
								divId: (_this2.props.commentDivIdPrefix || _constants.DEFAULT_COMMENT_DIV_ID_PREFIX) + comment.id
							});
						}));
					}
				}
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(0), __webpack_require__(38)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
/* WEBPACK VAR INJECTION */(function(process, global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
  ...
  (function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(19), __webpack_require__(93)))
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(65), __webpack_require__(58), __webpack_require__(31), __webpack_require__(29), __webpack_require__(10), __webpack_require__(5), __webpack_require__(4), __webpack_require__(7), __webpack_require__(25), __webpack_require__(24)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	...
	(function (global, factory) {
		...
		var apiUrls = {
			...
			getTranscriptionData: function getTranscriptionData(_ref6) {
				var cname = _ref6.cname;
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(30)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(4), __webpack_require__(5), __webpack_require__(51), __webpack_require__(46), __webpack_require__(15), __webpack_require__(32), __webpack_require__(7), __webpack_require__(8), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("../../actions"), require("@utils/enhancer"), require("@containers/TranscriptionSearchContainer"), require("@containers/TranscriptionFilterContainer"), require("@components/CommentPane"), require("./index.scss"), require("@config/constants"), require("@config/trackEvents"), require("@api/api"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.actions, global.enhancer, global.TranscriptionSearchContainer, global.TranscriptionFilterContainer, global.CommentPane, global.index, global.constants, global.trackEvents, global.api);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	(function (global, factory) {
	...
	})(undefined, function (module, exports, _preact, _actions, _enhancer, _TranscriptionSearchContainer, _TranscriptionFilterContainer, _CommentPane, _index, _constants, _trackEvents, _api) {
		"use strict";
		...
		var _TranscriptionSearchContainer2 = _interopRequireDefault(_TranscriptionSearchContainer);

		var _TranscriptionFilterContainer2 = _interopRequireDefault(_TranscriptionFilterContainer);
		...
		var TranscriptionContainer = function (_Component) {
			...
			function TranscriptionContainer(props) {
				...
				var _this = _possibleConstructorReturn(this, (TranscriptionContainer.__proto__ || Object.getPrototypeOf(TranscriptionContainer)).call(this, props));

				_this.onTranscriptionCardClickHandler = _this.onTranscriptionCardClickHandler.bind(_this);
				return _this;
			}
			...
			_createClass(TranscriptionContainer, [{
				...
				key: "onTranscriptionCardClickHandler",
				value: function onTranscriptionCardClickHandler(cardObj) {
					...
					(0, _api.track)(_trackEvents2.default.TRANSCRIPTION_CARD_CLICKED, {});
				}
			}, {
				key: "render",
				value: function render() {
					...
					return (0, _preact.h)("div", { className: _index2.default.heightCalcTranscription }, (0, _preact.h)("div", { className: [_index2.default.rightContainor, !loading && !error ? _index2.default.show : _index2.default.hide].join(" ") }, (0, _preact.h)("div", { className: [transcriptionStatus == "SUCCESS" ? _index2.default.show : _index2.default.hide].join(" ") }, (0, _preact.h)("div", { className: _index2.default.transcriptionSearch }, (0, _preact.h)(_TranscriptionSearchContainer2.default, {
						namespace: this.props.namespace
					}), (0, _preact.h)(_TranscriptionFilterContainer2.default, {
						namespace: this.props.namespace
					}), (0, _preact.h)("div", { className: _index2.default.clear })), (0, _preact.h)("div", { className: [this.props.searchWords.length == 0 ? _index2.default.heightCalcComment : _index2.default.heightCalcTagAdded].join(" ") }, (0, _preact.h)(_CommentPane2.default, {
					...
					}))), (0, _preact.h)("div", { className: [transcriptionStatus == "NOT_ENABLED" ? _index2.default.show : _index2.default.hide].join(" ") }, _constants.STRING_TRANSCRIPTION_NOT_ENABLED), (0, _preact.h)("div", { className: [transcriptionStatus == "FAILED" ? _index2.default.show : _index2.default.hide].join(" ") }, (0, _preact.h)("div", { className: [_index2.default.textalignC, _index2.default.F18, _index2.default.color66].join(" ") }, (0, _preact.h)("div", { className: _index2.default.transcriptionfailed }), (0, _preact.h)("div", { className: _index2.default.transcriptionFailedMessage, dangerouslySetInnerHTML: { __html: _constants.STRING_TRANSCRIPTION_FAILED } }))), (0, _preact.h)("div", { className: [transcriptionStatus == "STARTED" || transcriptionStatus == "NOT_STARTED" ? _index2.default.show : _index2.default.hide].join(" ") }, (0, _preact.h)("div", { className: _index2.default.transcriptionOnItsWay }, (0, _preact.h)("div", { className: [_index2.default.transcription_truck, _index2.default.marginT120, _index2.default.display_IB].join(" ") }), (0, _preact.h)("div", { className: _index2.default.transcriptionProgressMessage }, _constants.STRING_TRANSCRIPTION_IN_PROGRESS)))), (0, _preact.h)("div", { className: [_index2.default.rightContainor, loading ? _index2.default.show : _index2.default.hide].join(" ") }, _constants.STRING_FETCHING_TRANSCRIPTION_DATA), (0, _preact.h)("div", { className: [_index2.default.rightContainor, !loading && error ? _index2.default.show : _index2.default.hide].join(" ") }, _constants.STRING_FETCHING_TRANSCRIPTION_DATA_FAILED));
				}
			}]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(39), __webpack_require__(3), __webpack_require__(16), __webpack_require__(7), __webpack_require__(34)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(37), __webpack_require__(11), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 41 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 42 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 43 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 44 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(4), __webpack_require__(5), __webpack_require__(50), __webpack_require__(49), __webpack_require__(47), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("../../actions"), require("@utils/enhancer"), require("./index.scss"), require("images/filter.svg"), require("@components/MultiSelectDropdown"), require("@api/api"), require("@config/trackEvents"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.actions, global.enhancer, global.index, global.filter, global.MultiSelectDropdown, global.api, global.trackEvents);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	(function (global, factory) {
	...
	})(undefined, function (module, exports, _preact, _actions, _enhancer, _index, _filter, _MultiSelectDropdown, _api, _trackEvents) {
		"use strict";
		...
		var TranscriptionFilterContainer = function (_Component) {
			_inherits(TranscriptionFilterContainer, _Component);

			function TranscriptionFilterContainer(props) {
				_classCallCheck(this, TranscriptionFilterContainer);

				var _this = _possibleConstructorReturn(this, (TranscriptionFilterContainer.__proto__ || Object.getPrototypeOf(TranscriptionFilterContainer)).call(this, props));
			...
			_createClass(TranscriptionFilterContainer, [{
				...
				value: function onOptionsChangedHandler(_ref) {
					...
					var selectedEvalParams = this.props.evalParams.filter(function (evalParam) {
						return selectedEvalParamIds.indexOf(evalParam.evalParamId) > -1;
					});
				...
				value: function render() {
					...
					return (0, _preact.h)("div", { className: _index2.default.selectFilter, onBlur: this.hideFilters, tabIndex: "0" }, (0, _preact.h)("div", { className: [selectedOptions.length > 0 ? _index2.default.counter : _index2.default.hide].join(" ") }, selectedOptions.length), (0, _preact.h)("div", { className: _index2.default.filterIconHolder, onClick: this.onFilterClickHandler }, (0, _preact.h)("img", { src: _filter2.default, style: "height:18px;" })), (0, _preact.h)("div", { className: [!this.state.showFilters ? _index2.default.hide : null].join(" "), style: "width:300px;" }, (0, _preact.h)(_MultiSelectDropdown2.default, {
			...
			return TranscriptionFilterContainer;
		}(_preact.Component);
		...
		exports.default = (0, _enhancer.namespaceConnect)(mapStateToProps, _actions.actions)(TranscriptionFilterContainer);
		module.exports = exports["default"];
	});
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(48)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		...
		var MultiSelectDropdown = function (_Component) {
			...
			_createClass(MultiSelectDropdown, [{
				...
				value: function onOptionClick(option) {
					...
					this.props.onOptionsChangedHandler({ selectedOptions: this.state.selectedOptions, option: option, selected: selected });
				}
			}, {
				...
				value: function render() {
					...
					return (0, _preact.h)("div", { className: _index2.default.dropdownMenu }, (0, _preact.h)("ul", null, (0, _preact.h)("li", null, (0, _preact.h)("div", { className: _index2.default.menuItemHeading }, "Evaluation parameters")), options.map(function (option) {
...
module.exports = "data:image/svg+xml;base64,"
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(4), __webpack_require__(5), __webpack_require__(14), __webpack_require__(55), __webpack_require__(53), __webpack_require__(52), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("../../actions"), require("@utils/enhancer"), require("@models/transcriptionModel"), require("@components/SearchBar"), require("@components/SearchNavigationBar"), require("./index.scss"), require("@config/constants"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.actions, global.enhancer, global.transcriptionModel, global.SearchBar, global.SearchNavigationBar, global.index, global.constants);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	(function (global, factory) {
	...
	})(undefined, function (module, exports, _preact, _actions, _enhancer, _transcriptionModel, _SearchBar, _SearchNavigationBar, _index, _constants) {
		"use strict";
		...
		var TranscriptionSearchContainer = function (_Component) {
			_inherits(TranscriptionSearchContainer, _Component);

			function TranscriptionSearchContainer(props) {
				_classCallCheck(this, TranscriptionSearchContainer);

				var _this = _possibleConstructorReturn(this, (TranscriptionSearchContainer.__proto__ || Object.getPrototypeOf(TranscriptionSearchContainer)).call(this, props));
			...
			_createClass(TranscriptionSearchContainer, [{
				...
				key: "render",
				value: function render() {
					return (0, _preact.h)("div", { className: _index2.default.floatL }, (0, _preact.h)(_SearchBar2.default, {
						placeholder: _constants.STRING_TRANSCRIPTION_SEARCHBAR_PLACEHOLDER,
						searchWordsChangedHandler: this.searchWordsChangedHandler
					}), (0, _preact.h)("div", { className: [this.props.searchWords.length == 0 && _transcriptionModel2.default.getKeywordsInParams(this.props.selectedEvalParams).length == 0 ? _index2.default.hide : null].join(" ") }, (0, _preact.h)(_SearchNavigationBar2.default, {
						...
						noMatchFoundString: _constants.STRING_SEARCH_NAVIGATION_BAR_NO_MATCHES
					})));
				}
			}]);

			return TranscriptionSearchContainer;
		}(_preact.Component);
		...
		exports.default = (0, _enhancer.namespaceConnect)(mapStateToProps, _actions.actions)(TranscriptionSearchContainer);
		module.exports = exports["default"];
	});
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(54)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(57), __webpack_require__(56), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("images/close_w.svg"), require("./index.scss"), require("@api/api"), require("@config/trackEvents"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.close_w, global.index, global.api, global.trackEvents);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	})(undefined, function (module, exports, _preact, _close_w, _index, _api, _trackEvents) {
		"use strict";
		...
		var SearchBar = function (_Component) {
			...
			_createClass(SearchBar, [{
				...
				value: function addSearchWord(newWord) {
					...
					var searchWords = [].concat(_toConsumableArray(this.state.searchWords));
					if (this.state.searchWords.indexOf(newWord) == -1) {
						searchWords = [].concat(_toConsumableArray(searchWords), [newWord]);
					}
...
module.exports = "data:image/svg+xml;base64,"
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(15), __webpack_require__(63), __webpack_require__(61), __webpack_require__(4), __webpack_require__(5), __webpack_require__(60), __webpack_require__(7), __webpack_require__(59), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
module.exports = "data:image/svg+xml;base64,"
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(62)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(64)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(4), __webpack_require__(5), __webpack_require__(90), __webpack_require__(83), __webpack_require__(66)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(82), __webpack_require__(4), __webpack_require__(3), __webpack_require__(5), __webpack_require__(78), __webpack_require__(76), __webpack_require__(74), __webpack_require__(72), __webpack_require__(70), __webpack_require__(68), __webpack_require__(67)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		...
		var VideoControls = function (_Component) {
			...
			function VideoControls(props) {
				...
				_this.render = function (_ref, _ref2) {
					...
					var _controlOptions = _extends({}, defaultControlOptions, controlOptions);
					if ((0, _core.isIE)()) {
						_controlOptions.subtitles = false;
					}
					if (_this.video) {
						!_controlOptions.subtitles ? _this.disableSubtitles() : _this.applySubtitleState();
					}
					...
					var subtitlesOn = _this.state.subtitlesOn;
					...
					return (0, _preact.h)("div", {
					...
					}, currentTimeString), (0, _preact.h)("div", { className: _index2.default.floatR }, _controlOptions.subtitles && (0, _preact.h)("div", { className: _index2.default.controlButton }, (0, _preact.h)("div", null, (0, _preact.h)("button", {
						style: "border:none",
						type: "button",
						className: _index2.default.subtitles,
						onClick: _this.toggleSubtitles
					})), (0, _preact.h)("div", { className: [subtitlesOn ? _index2.default.subtitlesUnderline : null].join(" ") })), videoTracks && videoTracks.length > 1 && (0, _preact.h)("div", {
						...
						selectedTrack: selectedTrack
					})), _controlOptions.download && downloadSrc && (0, _preact.h)("div", { className: _index2.default.controlButton }, (0, _preact.h)("a", {
						target: "_blank",
						style: "border:none",
						type: "button",
						href: downloadSrc,
					...
					})), _controlOptions.fullScreen && (0, _preact.h)("div", { className: _index2.default.controlButton }, (0, _preact.h)("button", {
						style: "border:none",
						type: "button",
				...
				_this.applySubtitleState = _this.applySubtitleState.bind(_this);
				_this.showTrackList;
				_this.setState({
					showTrackList: false,
					subtitlesOn: true
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(71)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(73), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(75), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(77), __webpack_require__(4), __webpack_require__(3), __webpack_require__(5), __webpack_require__(11), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(81), __webpack_require__(4), __webpack_require__(3), __webpack_require__(5), __webpack_require__(16), __webpack_require__(7), __webpack_require__(11), __webpack_require__(79)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("./index.scss"), require("../../actions"), require("@utils/core"), require("@utils/enhancer"), require("@components/ConfirmAlertBox"), require("@config/constants"), require("@components/EmojiPicker"), require("@components/Loader"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.index, global.actions, global.core, global.enhancer, global.ConfirmAlertBox, global.constants, global.EmojiPicker, global.Loader);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	})(undefined, function (module, exports, _preact, _index, _actions, _core, _enhancer, _ConfirmAlertBox, _constants, _EmojiPicker, _Loader) {
		"use strict";
			...
			_createClass(CommentBox, [{
				...
				value: function postCommentHandler() {
					...
					this.setState({
						...
						console.log(_this3.state.disableSaveButton); //eslint-disable-line
					});
					if (this.props.id) {
						this.props.editComment({
							commentObj: {
				...
				value: function componentWillReceiveProps(nextProps) {
					...
					if (nextProps.showError) {
						...
						this.timer = setTimeout(function () {
							_this4.props.hideCommentBoxError();
						}, 3000);
					}
				}
			}, {
				...
				value: function shouldComponentUpdate(nextProps, nextState) {
					...
					var _state = this.state,
					    ...
					    disableSaveButton = _state.disableSaveButton;

					if (xPos !== nextProps.xPos || time !== nextProps.time || commentText !== nextProps.commentText || readOnly !== nextProps.readOnly || downArrowXPos !== nextProps.downArrowXPos || edit !== nextProps.edit || showError !== nextProps.showError || author !== nextProps.author || fullScreen !== nextProps.fullScreen, isSubmitting !== nextState.isSubmitting, disableSaveButton !== nextState.disableSaveButton) {
						return true;
					}
				...
				value: function render(_ref, _ref2) {
					...
					}, (0, _preact.h)(_EmojiPicker2.default, {
						toLeft: "true",
						onSelect: this.emojiOnSelectHandler
					}), !isSubmitting && (0, _preact.h)("span", {
						title: "save",
					...
					}), isSubmitting && (0, _preact.h)(_Loader2.default, null), (0, _preact.h)("span", {
						title: "discard",
						className: [_index2.default.acActionButton, _index2.default.cancel].join(" "),
						onClick: this.closeSelf
					})), showError && (0, _preact.h)("div", { className: [_index2.default.error, _index2.default.floatR].join(" ") }, "Something went wrong.Please try again..")));
				}
			}]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(80)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
	...
	(function (global, factory) {
		...
		var Loader = function Loader() {
			return (0, _preact.h)("div", { "class": _index2.default.ldsRing }, (0, _preact.h)("div", null), (0, _preact.h)("div", null), (0, _preact.h)("div", null), (0, _preact.h)("div", null));
		};
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(88), __webpack_require__(86), __webpack_require__(84), __webpack_require__(12)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(85)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(87)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(23), __webpack_require__(13), __webpack_require__(10), __webpack_require__(6), __webpack_require__(18), __webpack_require__(17)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if (typeof exports !== "undefined") {
		factory(module, exports, require("preact"), require("./app/index"), require("./app/store"), require("unistore/preact"), require("@api/api"), require("es6-promise"), require("whatwg-fetch"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, mod.exports, global.preact, global.index, global.store, global.preact, global.api, global.es6Promise, global.whatwgFetch);
		global.index = mod.exports;
	}
})(this, function (module, exports) {
	"use strict";
	...
	})(undefined, function (module, exports, _preact, _index, _store, _preact2, _api, _es6Promise) {
		"use strict";
...
exports.locals = {
	...
	"display_IB": "styles__display_IB___PLuWE",
	...
	"marginB5": "styles__marginB5___2YLO6",
	"marginB10": "styles__marginB10___49t6r",
	"marginB15": "styles__marginB15___LLUZU",
	"marginB20": "styles__marginB20___lJjtK",
	"marginB25": "styles__marginB25___P2tnQ",
	...
	"F18": "styles__F18___EN1Ny",
	"color66": "styles__color66___1aHq1",
...
// module
exports.push([module.i, "body {\n  font-family: \"Open Sans\", Arial, sans-serif; }\n\n {\n  button-outline: none; }\n  .ra-full-window {\n    width: 100% !important;\n    height: 100% !important; }\n  .fullScreen {\n    width: 100% !important;\n    height: 100% !important; }\n  .showScroll::-webkit-scrollbar {\n    -webkit-appearance: none;\n    width: 7px; }\n  .showScroll::-webkit-scrollbar-thumb {\n    border-radius: 4px;\n    background-color: rgba(0, 0, 0, 0.5);\n    -webkit-box-shadow: 0 0 1px rgba(255, 255, 255, 0.5); }\n  .currentMatchHighlightStyle {\n    background: #fff6ce;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n  .searchHighlightStyle {\n    background: #efefef;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n\n.TranscriptionContainer__ellipsis___15lKo {\n  overflow: hidden;\n  white-space: nowrap;\n  font-size: 13px;\n  text-overflow: ellipsis; }\n\n.TranscriptionContainer__pos_rel___1rAz9 {\n  position: relative; }\n\n.TranscriptionContainer__hide___116kj {\n  display: none; }\n\n.TranscriptionContainer__display_IB___3iqW5 {\n  display: inline-block; }\n\n.TranscriptionContainer__show___17nND {\n  display: block; }\n\n.TranscriptionContainer__visible___tLPow {\n  visibility: visible; }\n\n.TranscriptionContainer__invisible___hEm9b {\n  visibility: hidden; }\n\n.TranscriptionContainer__textalignC___1VwFW {\n  text-align: center; }\n\n.TranscriptionContainer__floatL___1Vs0l {\n  float: left; }\n\n.TranscriptionContainer__floatR___1nOAS {\n  float: right; }\n\n.TranscriptionContainer__marginR7___1-4n6 {\n  margin-right: 7px; }\n\n.TranscriptionContainer__marginT8___pJpWO {\n  margin-top: 8px; }\n\n.TranscriptionContainer__marginT14___w5MYJ {\n  margin-top: 14px; }\n\n.TranscriptionContainer__marginT9___2TJMx {\n  margin-top: 9px; }\n\n.TranscriptionContainer__marginT6___BAY4r {\n  margin-top: 6px; }\n\n.TranscriptionContainer__marginT10___1HKn9 {\n  margin-top: 10px; }\n\n.TranscriptionContainer__marginB5___3QwFh {\n  margin-bottom: 5px; }\n\n.TranscriptionContainer__marginB10___2xbgh {\n  margin-bottom: 10px; }\n\n.TranscriptionContainer__marginB15___Pvtne {\n  margin-bottom: 15px; }\n\n.TranscriptionContainer__marginB20___1F4z- {\n  margin-bottom: 20px; }\n\n.TranscriptionContainer__marginB25___KwAoz {\n  margin-bottom: 25px; }\n\n.TranscriptionContainer__marginR12___24d-r {\n  margin-right: 12px; }\n\n.TranscriptionContainer__marginR15___1OICn {\n  margin-right: 15px; }\n\n.TranscriptionContainer__marginR20___3Wg_d {\n  margin-right: 20px; }\n\n.TranscriptionContainer__paddingT5___iEPi0 {\n  padding-top: 5px; }\n\n.TranscriptionContainer__clear___1wGdu {\n  clear: both; }\n\n.TranscriptionContainer__marginT14___w5MYJ {\n  margin-top: 14px; }\n\n.TranscriptionContainer__lineHeight30___5P-oI {\n  line-height: 30px; }\n\n.TranscriptionContainer__lineHeight20___3wVat {\n  line-height: 20px; }\n\n.TranscriptionContainer__lineHeight18___ZakiR {\n  line-height: 18px; }\n\n.TranscriptionContainer__F12___3D_80 {\n  font-size: 12px; }\n\n.TranscriptionContainer__F18___OBUo9 {\n  font-size: 18px; }\n\n.TranscriptionContainer__color66___2YfK2 {\n  color: #666666; }\n\n.TranscriptionContainer__orangeColor___12BZ7 {\n  color: #ff8a16; }\n\n.TranscriptionContainer__onBoardingContainer___1Pt7Q {\n  position: absolute;\n  left: 50%;\n  top: 20px;\n  margin-left: -160px; }\n\n.TranscriptionContainer__error___UwFHQ {\n  color: red;\n  font-size: 10px; }\n\n.TranscriptionContainer__rightContainor___30twc {\n  width: 100%; }\n  .TranscriptionContainer__rightContainor___30twc .TranscriptionContainer__transcriptionSearch___31ikS {\n    padding: 30px 40px 0px 20px;\n    margin-bottom: 15px; }\n\n.TranscriptionContainer__heightCalcTranscription___2mco- {\n  height: calc(100vh - 201px); }\n\n.TranscriptionContainer__heightCalcComment___3chOh {\n  overflow-x: auto;\n  height: calc(100vh - 288px); }\n\n.TranscriptionContainer__heightCalcTagAdded___19KAz {\n  overflow-x: auto;\n  height: calc(100vh - 317px); }\n\n.TranscriptionContainer__transcriptionOnItsWay___28tJH {\n  text-align: center;\n  padding-top: 120px;\n  padding-bottom: 20px; }\n  .TranscriptionContainer__transcriptionOnItsWay___28tJH .TranscriptionContainer__transcription_truck___3wpzX {\n    height: 57px;\n    width: 101px;\n    background-image: url(" + escape(__webpack_require__(98)) + ");\n    background-repeat: no-repeat; }\n\n.TranscriptionContainer__transcriptionfailed___guWw1 {\n  height: 110px;\n  width: 216px;\n  background-image: url(" + escape(__webpack_require__(99)) + ");\n  background-repeat: no-repeat;\n  margin: 80px auto 34px auto; }\n\n.TranscriptionContainer__transcriptionFailedMessage___sq-Hy {\n  padding: 0px 80px; }\n\n.TranscriptionContainer__transcriptionProgressMessage___f3pRU {\n  font-size: 18px;\n  color: #666666;\n  margin-top: 30px;\n  margin-bottom: 30px; }\n", ""]);

// exports
exports.locals = {
	"ellipsis": "TranscriptionContainer__ellipsis___15lKo",
	"pos_rel": "TranscriptionContainer__pos_rel___1rAz9",
	"hide": "TranscriptionContainer__hide___116kj",
	"display_IB": "TranscriptionContainer__display_IB___3iqW5",
	"show": "TranscriptionContainer__show___17nND",
	"visible": "TranscriptionContainer__visible___tLPow",
	"invisible": "TranscriptionContainer__invisible___hEm9b",
	"textalignC": "TranscriptionContainer__textalignC___1VwFW",
	"floatL": "TranscriptionContainer__floatL___1Vs0l",
	"floatR": "TranscriptionContainer__floatR___1nOAS",
	"marginR7": "TranscriptionContainer__marginR7___1-4n6",
	"marginT8": "TranscriptionContainer__marginT8___pJpWO",
	"marginT14": "TranscriptionContainer__marginT14___w5MYJ",
	"marginT9": "TranscriptionContainer__marginT9___2TJMx",
	"marginT6": "TranscriptionContainer__marginT6___BAY4r",
	"marginT10": "TranscriptionContainer__marginT10___1HKn9",
	"marginB5": "TranscriptionContainer__marginB5___3QwFh",
	"marginB10": "TranscriptionContainer__marginB10___2xbgh",
	"marginB15": "TranscriptionContainer__marginB15___Pvtne",
	"marginB20": "TranscriptionContainer__marginB20___1F4z-",
	"marginB25": "TranscriptionContainer__marginB25___KwAoz",
	"marginR12": "TranscriptionContainer__marginR12___24d-r",
	"marginR15": "TranscriptionContainer__marginR15___1OICn",
	"marginR20": "TranscriptionContainer__marginR20___3Wg_d",
	"paddingT5": "TranscriptionContainer__paddingT5___iEPi0",
	"clear": "TranscriptionContainer__clear___1wGdu",
	"lineHeight30": "TranscriptionContainer__lineHeight30___5P-oI",
	"lineHeight20": "TranscriptionContainer__lineHeight20___3wVat",
	"lineHeight18": "TranscriptionContainer__lineHeight18___ZakiR",
	"F12": "TranscriptionContainer__F12___3D_80",
	"F18": "TranscriptionContainer__F18___OBUo9",
	"color66": "TranscriptionContainer__color66___2YfK2",
	"orangeColor": "TranscriptionContainer__orangeColor___12BZ7",
	"onBoardingContainer": "TranscriptionContainer__onBoardingContainer___1Pt7Q",
	"error": "TranscriptionContainer__error___UwFHQ",
	"rightContainor": "TranscriptionContainer__rightContainor___30twc",
	"transcriptionSearch": "TranscriptionContainer__transcriptionSearch___31ikS",
	"heightCalcTranscription": "TranscriptionContainer__heightCalcTranscription___2mco-",
	"heightCalcComment": "TranscriptionContainer__heightCalcComment___3chOh",
	"heightCalcTagAdded": "TranscriptionContainer__heightCalcTagAdded___19KAz",
	"transcriptionOnItsWay": "TranscriptionContainer__transcriptionOnItsWay___28tJH",
	"transcription_truck": "TranscriptionContainer__transcription_truck___3wpzX",
	"transcriptionfailed": "TranscriptionContainer__transcriptionfailed___guWw1",
	"transcriptionFailedMessage": "TranscriptionContainer__transcriptionFailedMessage___sq-Hy",
	"transcriptionProgressMessage": "TranscriptionContainer__transcriptionProgressMessage___f3pRU"
};
...
exports.locals = {
	...
	"display_IB": "EmojiPicker__display_IB___3_dGs",
	...
	"marginB5": "EmojiPicker__marginB5___spO6_",
	"marginB10": "EmojiPicker__marginB10___34aSQ",
	"marginB15": "EmojiPicker__marginB15___6reha",
	"marginB20": "EmojiPicker__marginB20___2PWWo",
	"marginB25": "EmojiPicker__marginB25___1Gk_M",
	...
	"F18": "EmojiPicker__F18___2krbA",
	"color66": "EmojiPicker__color66___1o9LK",
...
exports.locals = {
	...
	"display_IB": "CommentCard__display_IB___11kaY",
	...
	"marginB5": "CommentCard__marginB5___SRGuM",
	"marginB10": "CommentCard__marginB10___23u-O",
	"marginB15": "CommentCard__marginB15___2jFJm",
	"marginB20": "CommentCard__marginB20___1czvP",
	"marginB25": "CommentCard__marginB25___2_Tiy",
	...
	"F18": "CommentCard__F18___2fFLN",
	"color66": "CommentCard__color66___2Tbho",
...
exports.locals = {
	...
	"display_IB": "MultiSelectDropdown__display_IB___2LnzK",
	...
	"marginB5": "MultiSelectDropdown__marginB5___3Fgw-",
	"marginB10": "MultiSelectDropdown__marginB10___2r9aa",
	"marginB15": "MultiSelectDropdown__marginB15___3BCIx",
	"marginB20": "MultiSelectDropdown__marginB20___2oLpR",
	"marginB25": "MultiSelectDropdown__marginB25___iEVvh",
	...
	"F18": "MultiSelectDropdown__F18___uEhXI",
	"color66": "MultiSelectDropdown__color66___3C81J",
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 107 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
// module
exports.push([module.i, "body {\n  font-family: \"Open Sans\", Arial, sans-serif; }\n\n {\n  button-outline: none; }\n  .ra-full-window {\n    width: 100% !important;\n    height: 100% !important; }\n  .fullScreen {\n    width: 100% !important;\n    height: 100% !important; }\n  .showScroll::-webkit-scrollbar {\n    -webkit-appearance: none;\n    width: 7px; }\n  .showScroll::-webkit-scrollbar-thumb {\n    border-radius: 4px;\n    background-color: rgba(0, 0, 0, 0.5);\n    -webkit-box-shadow: 0 0 1px rgba(255, 255, 255, 0.5); }\n  .currentMatchHighlightStyle {\n    background: #fff6ce;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n  .searchHighlightStyle {\n    background: #efefef;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n\n.TranscriptionFilterContainer__ellipsis___1TBBz {\n  overflow: hidden;\n  white-space: nowrap;\n  font-size: 13px;\n  text-overflow: ellipsis; }\n\n.TranscriptionFilterContainer__pos_rel___JLDws {\n  position: relative; }\n\n.TranscriptionFilterContainer__hide___2tNZC {\n  display: none; }\n\n.TranscriptionFilterContainer__display_IB___3nO_L {\n  display: inline-block; }\n\n.TranscriptionFilterContainer__show___fT16v {\n  display: block; }\n\n.TranscriptionFilterContainer__visible___3s-FQ {\n  visibility: visible; }\n\n.TranscriptionFilterContainer__invisible___3nbID {\n  visibility: hidden; }\n\n.TranscriptionFilterContainer__textalignC___2JMRK {\n  text-align: center; }\n\n.TranscriptionFilterContainer__floatL___1jW-Z {\n  float: left; }\n\n.TranscriptionFilterContainer__floatR___28WFh {\n  float: right; }\n\n.TranscriptionFilterContainer__marginR7___1i_-d {\n  margin-right: 7px; }\n\n.TranscriptionFilterContainer__marginT8___8qiOj {\n  margin-top: 8px; }\n\n.TranscriptionFilterContainer__marginT14___1EWkJ {\n  margin-top: 14px; }\n\n.TranscriptionFilterContainer__marginT9___3BK_Y {\n  margin-top: 9px; }\n\n.TranscriptionFilterContainer__marginT6___3swAe {\n  margin-top: 6px; }\n\n.TranscriptionFilterContainer__marginT10___1lk1M {\n  margin-top: 10px; }\n\n.TranscriptionFilterContainer__marginB5___318cF {\n  margin-bottom: 5px; }\n\n.TranscriptionFilterContainer__marginB10___P1HaE {\n  margin-bottom: 10px; }\n\n.TranscriptionFilterContainer__marginB15___1QuAY {\n  margin-bottom: 15px; }\n\n.TranscriptionFilterContainer__marginB20___1E-Ey {\n  margin-bottom: 20px; }\n\n.TranscriptionFilterContainer__marginB25___3arev {\n  margin-bottom: 25px; }\n\n.TranscriptionFilterContainer__marginR12___mErIc {\n  margin-right: 12px; }\n\n.TranscriptionFilterContainer__marginR15___12Rb2 {\n  margin-right: 15px; }\n\n.TranscriptionFilterContainer__marginR20___3Yp_2 {\n  margin-right: 20px; }\n\n.TranscriptionFilterContainer__paddingT5___gHjys {\n  padding-top: 5px; }\n\n.TranscriptionFilterContainer__clear___17mQ8 {\n  clear: both; }\n\n.TranscriptionFilterContainer__marginT14___1EWkJ {\n  margin-top: 14px; }\n\n.TranscriptionFilterContainer__lineHeight30___1_QO9 {\n  line-height: 30px; }\n\n.TranscriptionFilterContainer__lineHeight20___2QfAH {\n  line-height: 20px; }\n\n.TranscriptionFilterContainer__lineHeight18___2HfzM {\n  line-height: 18px; }\n\n.TranscriptionFilterContainer__F12___21W-N {\n  font-size: 12px; }\n\n.TranscriptionFilterContainer__F18___3EAE9 {\n  font-size: 18px; }\n\n.TranscriptionFilterContainer__color66___3teuq {\n  color: #666666; }\n\n.TranscriptionFilterContainer__orangeColor___17LZK {\n  color: #ff8a16; }\n\n.TranscriptionFilterContainer__onBoardingContainer___Ds4DS {\n  position: absolute;\n  left: 50%;\n  top: 20px;\n  margin-left: -160px; }\n\n.TranscriptionFilterContainer__error___2tot3 {\n  color: red;\n  font-size: 10px; }\n\n.TranscriptionFilterContainer__selectFilter___3iiUC {\n  float: left;\n  position: relative;\n  width: 27px;\n  z-index: 9;\n  outline: none;\n  margin-left: 10px; }\n  .TranscriptionFilterContainer__selectFilter___3iiUC .TranscriptionFilterContainer__counter___2Ly8K {\n    background: #0072BC;\n    padding: 1px 5px;\n    color: white;\n    position: absolute;\n    top: -5px;\n    right: -9px;\n    border-radius: 15px;\n    font-size: 11px; }\n  .TranscriptionFilterContainer__selectFilter___3iiUC .TranscriptionFilterContainer__filterIconHolder___2ewy5 {\n    border: 1px solid #ddd;\n    background: #fff;\n    padding: 4px;\n    height: 28px;\n    cursor: pointer;\n    width: 28px; }\n", ""]);

// exports
exports.locals = {
	"ellipsis": "TranscriptionFilterContainer__ellipsis___1TBBz",
	"pos_rel": "TranscriptionFilterContainer__pos_rel___JLDws",
	"hide": "TranscriptionFilterContainer__hide___2tNZC",
	"display_IB": "TranscriptionFilterContainer__display_IB___3nO_L",
	"show": "TranscriptionFilterContainer__show___fT16v",
	"visible": "TranscriptionFilterContainer__visible___3s-FQ",
	"invisible": "TranscriptionFilterContainer__invisible___3nbID",
	"textalignC": "TranscriptionFilterContainer__textalignC___2JMRK",
	"floatL": "TranscriptionFilterContainer__floatL___1jW-Z",
	"floatR": "TranscriptionFilterContainer__floatR___28WFh",
	"marginR7": "TranscriptionFilterContainer__marginR7___1i_-d",
	"marginT8": "TranscriptionFilterContainer__marginT8___8qiOj",
	"marginT14": "TranscriptionFilterContainer__marginT14___1EWkJ",
	"marginT9": "TranscriptionFilterContainer__marginT9___3BK_Y",
	"marginT6": "TranscriptionFilterContainer__marginT6___3swAe",
	"marginT10": "TranscriptionFilterContainer__marginT10___1lk1M",
	"marginB5": "TranscriptionFilterContainer__marginB5___318cF",
	"marginB10": "TranscriptionFilterContainer__marginB10___P1HaE",
	"marginB15": "TranscriptionFilterContainer__marginB15___1QuAY",
	"marginB20": "TranscriptionFilterContainer__marginB20___1E-Ey",
	"marginB25": "TranscriptionFilterContainer__marginB25___3arev",
	"marginR12": "TranscriptionFilterContainer__marginR12___mErIc",
	"marginR15": "TranscriptionFilterContainer__marginR15___12Rb2",
	"marginR20": "TranscriptionFilterContainer__marginR20___3Yp_2",
	"paddingT5": "TranscriptionFilterContainer__paddingT5___gHjys",
	"clear": "TranscriptionFilterContainer__clear___17mQ8",
	"lineHeight30": "TranscriptionFilterContainer__lineHeight30___1_QO9",
	"lineHeight20": "TranscriptionFilterContainer__lineHeight20___2QfAH",
	"lineHeight18": "TranscriptionFilterContainer__lineHeight18___2HfzM",
	"F12": "TranscriptionFilterContainer__F12___21W-N",
	"F18": "TranscriptionFilterContainer__F18___3EAE9",
	"color66": "TranscriptionFilterContainer__color66___3teuq",
	"orangeColor": "TranscriptionFilterContainer__orangeColor___17LZK",
	"onBoardingContainer": "TranscriptionFilterContainer__onBoardingContainer___Ds4DS",
	"error": "TranscriptionFilterContainer__error___2tot3",
	"selectFilter": "TranscriptionFilterContainer__selectFilter___3iiUC",
	"counter": "TranscriptionFilterContainer__counter___2Ly8K",
	"filterIconHolder": "TranscriptionFilterContainer__filterIconHolder___2ewy5"
};
...
// module
exports.push([module.i, "body {\n  font-family: \"Open Sans\", Arial, sans-serif; }\n\n {\n  button-outline: none; }\n  .ra-full-window {\n    width: 100% !important;\n    height: 100% !important; }\n  .fullScreen {\n    width: 100% !important;\n    height: 100% !important; }\n  .showScroll::-webkit-scrollbar {\n    -webkit-appearance: none;\n    width: 7px; }\n  .showScroll::-webkit-scrollbar-thumb {\n    border-radius: 4px;\n    background-color: rgba(0, 0, 0, 0.5);\n    -webkit-box-shadow: 0 0 1px rgba(255, 255, 255, 0.5); }\n  .currentMatchHighlightStyle {\n    background: #fff6ce;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n  .searchHighlightStyle {\n    background: #efefef;\n    font-weight: normal;\n    border-radius: 4px;\n    padding: 0 2px;\n    display: inline-block; }\n\n.TranscriptionSearchContainer__ellipsis___28HeI {\n  overflow: hidden;\n  white-space: nowrap;\n  font-size: 13px;\n  text-overflow: ellipsis; }\n\n.TranscriptionSearchContainer__pos_rel___2TI8F {\n  position: relative; }\n\n.TranscriptionSearchContainer__hide___3hcHY {\n  display: none; }\n\n.TranscriptionSearchContainer__display_IB___3v09b {\n  display: inline-block; }\n\n.TranscriptionSearchContainer__show___ODW2x {\n  display: block; }\n\n.TranscriptionSearchContainer__visible___2YDtA {\n  visibility: visible; }\n\n.TranscriptionSearchContainer__invisible___3aPUu {\n  visibility: hidden; }\n\n.TranscriptionSearchContainer__textalignC___2yj5a {\n  text-align: center; }\n\n.TranscriptionSearchContainer__floatL___31z5d {\n  float: left; }\n\n.TranscriptionSearchContainer__floatR___3bVZj {\n  float: right; }\n\n.TranscriptionSearchContainer__marginR7___iVqL8 {\n  margin-right: 7px; }\n\n.TranscriptionSearchContainer__marginT8___2HU57 {\n  margin-top: 8px; }\n\n.TranscriptionSearchContainer__marginT14___9U7ze {\n  margin-top: 14px; }\n\n.TranscriptionSearchContainer__marginT9___2X5Zr {\n  margin-top: 9px; }\n\n.TranscriptionSearchContainer__marginT6___22FJb {\n  margin-top: 6px; }\n\n.TranscriptionSearchContainer__marginT10___2my0d {\n  margin-top: 10px; }\n\n.TranscriptionSearchContainer__marginB5___1MGr4 {\n  margin-bottom: 5px; }\n\n.TranscriptionSearchContainer__marginB10___3iP2K {\n  margin-bottom: 10px; }\n\n.TranscriptionSearchContainer__marginB15___3rnOj {\n  margin-bottom: 15px; }\n\n.TranscriptionSearchContainer__marginB20___2nA4W {\n  margin-bottom: 20px; }\n\n.TranscriptionSearchContainer__marginB25___2kUNt {\n  margin-bottom: 25px; }\n\n.TranscriptionSearchContainer__marginR12___27QjX {\n  margin-right: 12px; }\n\n.TranscriptionSearchContainer__marginR15___1He29 {\n  margin-right: 15px; }\n\n.TranscriptionSearchContainer__marginR20___25AKV {\n  margin-right: 20px; }\n\n.TranscriptionSearchContainer__paddingT5___3Q0QH {\n  padding-top: 5px; }\n\n.TranscriptionSearchContainer__clear___2NpAw {\n  clear: both; }\n\n.TranscriptionSearchContainer__marginT14___9U7ze {\n  margin-top: 14px; }\n\n.TranscriptionSearchContainer__lineHeight30___9UkDE {\n  line-height: 30px; }\n\n.TranscriptionSearchContainer__lineHeight20___2izKv {\n  line-height: 20px; }\n\n.TranscriptionSearchContainer__lineHeight18___13s1Q {\n  line-height: 18px; }\n\n.TranscriptionSearchContainer__F12___UOt0E {\n  font-size: 12px; }\n\n.TranscriptionSearchContainer__F18___1SyfQ {\n  font-size: 18px; }\n\n.TranscriptionSearchContainer__color66___3PLzk {\n  color: #666666; }\n\n.TranscriptionSearchContainer__orangeColor___UZvWh {\n  color: #ff8a16; }\n\n.TranscriptionSearchContainer__onBoardingContainer___QP7HJ {\n  position: absolute;\n  left: 50%;\n  top: 20px;\n  margin-left: -160px; }\n\n.TranscriptionSearchContainer__error___OCqdE {\n  color: red;\n  font-size: 10px; }\n", ""]);

// exports
exports.locals = {
	"ellipsis": "TranscriptionSearchContainer__ellipsis___28HeI",
	"pos_rel": "TranscriptionSearchContainer__pos_rel___2TI8F",
	"hide": "TranscriptionSearchContainer__hide___3hcHY",
	"display_IB": "TranscriptionSearchContainer__display_IB___3v09b",
	"show": "TranscriptionSearchContainer__show___ODW2x",
	"visible": "TranscriptionSearchContainer__visible___2YDtA",
	"invisible": "TranscriptionSearchContainer__invisible___3aPUu",
	"textalignC": "TranscriptionSearchContainer__textalignC___2yj5a",
	"floatL": "TranscriptionSearchContainer__floatL___31z5d",
	"floatR": "TranscriptionSearchContainer__floatR___3bVZj",
	"marginR7": "TranscriptionSearchContainer__marginR7___iVqL8",
	"marginT8": "TranscriptionSearchContainer__marginT8___2HU57",
	"marginT14": "TranscriptionSearchContainer__marginT14___9U7ze",
	"marginT9": "TranscriptionSearchContainer__marginT9___2X5Zr",
	"marginT6": "TranscriptionSearchContainer__marginT6___22FJb",
	"marginT10": "TranscriptionSearchContainer__marginT10___2my0d",
	"marginB5": "TranscriptionSearchContainer__marginB5___1MGr4",
	"marginB10": "TranscriptionSearchContainer__marginB10___3iP2K",
	"marginB15": "TranscriptionSearchContainer__marginB15___3rnOj",
	"marginB20": "TranscriptionSearchContainer__marginB20___2nA4W",
	"marginB25": "TranscriptionSearchContainer__marginB25___2kUNt",
	"marginR12": "TranscriptionSearchContainer__marginR12___27QjX",
	"marginR15": "TranscriptionSearchContainer__marginR15___1He29",
	"marginR20": "TranscriptionSearchContainer__marginR20___25AKV",
	"paddingT5": "TranscriptionSearchContainer__paddingT5___3Q0QH",
	"clear": "TranscriptionSearchContainer__clear___2NpAw",
	"lineHeight30": "TranscriptionSearchContainer__lineHeight30___9UkDE",
	"lineHeight20": "TranscriptionSearchContainer__lineHeight20___2izKv",
	"lineHeight18": "TranscriptionSearchContainer__lineHeight18___13s1Q",
	"F12": "TranscriptionSearchContainer__F12___UOt0E",
	"F18": "TranscriptionSearchContainer__F18___1SyfQ",
	"color66": "TranscriptionSearchContainer__color66___3PLzk",
	"orangeColor": "TranscriptionSearchContainer__orangeColor___UZvWh",
	"onBoardingContainer": "TranscriptionSearchContainer__onBoardingContainer___QP7HJ",
	"error": "TranscriptionSearchContainer__error___OCqdE"
};
...
exports.locals = {
	...
	"display_IB": "SearchNavigationBar__display_IB___3Var1",
	...
	"marginB5": "SearchNavigationBar__marginB5___1AjyT",
	"marginB10": "SearchNavigationBar__marginB10___3N8Vp",
	"marginB15": "SearchNavigationBar__marginB15___3eM0_",
	"marginB20": "SearchNavigationBar__marginB20___1qkfe",
	"marginB25": "SearchNavigationBar__marginB25___2knPg",
	...
	"F18": "SearchNavigationBar__F18___24q6e",
	"color66": "SearchNavigationBar__color66___2D454",
...
module.exports = "data:image/svg+xml;base64,"
...
exports.locals = {
	...
	"display_IB": "SearchBar__display_IB___1zQ2b",
	...
	"marginB5": "SearchBar__marginB5___1YLZP",
	"marginB10": "SearchBar__marginB10___1qz73",
	"marginB15": "SearchBar__marginB15___3djAt",
	"marginB20": "SearchBar__marginB20___1TvCP",
	"marginB25": "SearchBar__marginB25___13Rzl",
	...
	"F18": "SearchBar__F18___ZHjKy",
	"color66": "SearchBar__color66___3CeFF",
...
module.exports = "data:image/svg+xml;base64,"
...
exports.locals = {
	...
	"display_IB": "VolumeBar__display_IB___3HWr4",
	...
	"marginB5": "VolumeBar__marginB5___73A_U",
	"marginB10": "VolumeBar__marginB10___GNzaU",
	"marginB15": "VolumeBar__marginB15___3dX2h",
	"marginB20": "VolumeBar__marginB20___Cc8Cg",
	"marginB25": "VolumeBar__marginB25___1JnpQ",
	...
	"F18": "VolumeBar__F18___16WKe",
	"color66": "VolumeBar__color66___Egzfi",
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 122 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
exports.locals = {
	...
	"display_IB": "TimeBar__display_IB____TsHM",
	...
	"marginB5": "TimeBar__marginB5___p4Wxe",
	"marginB10": "TimeBar__marginB10___1Cuje",
	"marginB15": "TimeBar__marginB15___CeWy_",
	"marginB20": "TimeBar__marginB20___3FYom",
	"marginB25": "TimeBar__marginB25___3Bmlx",
	...
	"F18": "TimeBar__F18___2d4fR",
	"color66": "TimeBar__color66___2Rb8-",
...
// module
exports.push([module.i, ".Loader__ldsRing___2I8PO {\n  display: inline-block;\n  position: relative;\n  width: 25px;\n  height: 25px; }\n\n.Loader__ldsRing___2I8PO div {\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  display: block;\n  position: absolute;\n  width: 20px;\n  height: 20px;\n  margin: 6px;\n  border: 2px solid #0072BC;\n  border-radius: 50%;\n  -webkit-animation: Loader__ldsRing___2I8PO 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n          animation: Loader__ldsRing___2I8PO 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;\n  border-color: #0072BC transparent transparent transparent; }\n\n.Loader__ldsRing___2I8PO div:nth-child(1) {\n  -webkit-animation-delay: -0.45s;\n          animation-delay: -0.45s; }\n\n.Loader__ldsRing___2I8PO div:nth-child(2) {\n  -webkit-animation-delay: -0.3s;\n          animation-delay: -0.3s; }\n\n.Loader__ldsRing___2I8PO div:nth-child(3) {\n  -webkit-animation-delay: -0.15s;\n          animation-delay: -0.15s; }\n\n@-webkit-keyframes Loader__ldsRing___2I8PO {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg); } }\n\n@keyframes Loader__ldsRing___2I8PO {\n  0% {\n    -webkit-transform: rotate(0deg);\n            transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg);\n            transform: rotate(360deg); } }\n", ""]);

// exports
exports.locals = {
	"ldsRing": "Loader__ldsRing___2I8PO"
};
...
exports.locals = {
	...
	"display_IB": "CommentBox__display_IB___3bGpi",
	...
	"marginB5": "CommentBox__marginB5___1Z_wD",
	"marginB10": "CommentBox__marginB10___26ezr",
	"marginB15": "CommentBox__marginB15___13FWL",
	"marginB20": "CommentBox__marginB20___2k1kp",
	"marginB25": "CommentBox__marginB25___AcaHs",
	...
	"F18": "CommentBox__F18___xW6db",
	"color66": "CommentBox__color66___1DtYw",
...
exports.locals = {
	...
	"display_IB": "VideoControls__display_IB___3JM8v",
	...
	"marginB5": "VideoControls__marginB5___2CMwS",
	"marginB10": "VideoControls__marginB10___153mj",
	"marginB15": "VideoControls__marginB15___Rp1t6",
	"marginB20": "VideoControls__marginB20___3KQky",
	"marginB25": "VideoControls__marginB25___2uSug",
	...
	"F18": "VideoControls__F18___lOwBW",
	"color66": "VideoControls__color66___3ndpj",
	...
	"subtitles": "VideoControls__subtitles___3eY0r",
	"subtitlesUnderline": "VideoControls__subtitlesUnderline___MmJUT",
...
module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 129 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 130 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 131 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"

/***/ }),
/* 132 */
/***/ (function(module, exports) {

module.exports = "data:image/svg+xml;base64,"
...
// module
exports.push([module.i, ".Player__play___1vInF {\n  background: url(" + escape(__webpack_require__(89)) + ") no-repeat 0px 0px transparent;\n  top: 40%;\n  left: 42%;\n  width: 76px;\n  height: 76px;\n  position: absolute;\n  cursor: pointer; }\n\n.Player__playerContainer___xs7AU {\n  height: 100%;\n  cursor: pointer; }\n", ""]);
...
exports.locals = {
	...
	"display_IB": "VideoPlayer__display_IB___2CLoD",
	...
	"marginB5": "VideoPlayer__marginB5___2n4Qt",
	"marginB10": "VideoPlayer__marginB10___3rGVb",
	"marginB15": "VideoPlayer__marginB15___10fp9",
	"marginB20": "VideoPlayer__marginB20___1_y7B",
	"marginB25": "VideoPlayer__marginB25___3GtKF",
	...
	"F18": "VideoPlayer__F18___12TKQ",
	"color66": "VideoPlayer__color66___3iuXD",
