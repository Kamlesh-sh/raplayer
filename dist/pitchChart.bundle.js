		...
		var PitchChart = function () {
			...
			_createClass(PitchChart, [{
				...
				value: function setup() {
					...
					try {
						this.root = (0, _preact.render)((0, _preact.h)(_preact2.Provider, { store: store }, (0, _preact.h)(_PitchChartWrapper2.default, _extends({}, this.props, { namespace: namespace })), "dasdasdasdas"), containerEl);
					} catch (ex) {
